  ...
  return (
    <div className="max-w-[1280px] mx-auto">
      <div className="relative">
        ...
        <div className="absolute inset-0 -z-10 w-full top-0 grid grid-cols-5 grid-rows-1 h-screen">
          <div className="col-span-2 grid grid-rows-2">
            <div className="bg-white"></div>
            <div className="bg-black"></div>
          </div>
          <div
            className="col-span-3 row-span-2 bg-blend-hard-light bg-cover bg-center bg-[url()]"
